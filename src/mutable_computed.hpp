...
namespace live_cells {
     ...
     */
    template <typename A1, typename A2, typename... As>
    auto mutable_computed(key_ref key, A1 arg1, A2 arg2, As... args) {
        auto packed = internal::pack<2>(arg1, arg2, args...);
        ...
        return std::apply([&] (auto... args) {
            ...
            return make_mutable_compute_cell(key, fn, reverse, args...);
        }, fn_args);
    }
     ...
     */
    template <typename A1, typename A2, typename... As>
    auto mutable_computed(changes_only_option option, key_ref key, A1 arg1, A2 arg2, As... args) {
        auto packed = internal::pack<2>(arg1, arg2, args...);
        ...
        return std::apply([&] (auto... args) {
            ...
            return make_mutable_compute_cell(changes_only, key, fn, reverse, args...);
        }, fn_args);
    }
